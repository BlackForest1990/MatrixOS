...
本文是编写自己的x86操作系统的实用指南。它旨在提供足够的技术细节帮助，同时不过多展示示例和代码片段。

作者作为一名有4年经验的代码工作者，之前的工作总是作流程性的编码工作，处理的业务问题多，关注的底层问题少，自从感受到了GNU的精神，我决定要总结一下自己的知识，设计一个轻量的OS，并实现它，而且能够稳定运行。本文是恶劣的模仿之作，如果有朋友需要借鉴，自无不可。
